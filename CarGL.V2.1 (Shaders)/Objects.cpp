...
float coloresco_c[2][4] = { {0.8, 0.5, 0.0, 1.0}, {0.5, 0.5, 0.5, 1.0}}; // Color del coche
...
TPrimitiva::TPrimitiva(int DL, int t)
{
	...
	switch (tipo) {
		case CARRETERA_ID: {  // Creación de la carretera
            ...
            //modelo0 = Load3DS("../../Modelos/casitodo.3ds", &num_vertices0);
            //modelo1 = Load3DS("../../Modelos/Lines.3ds", &num_vertices1);

            break;
		}

		case CASAS_ID: {  // Creación de la carretera
		    tx = ty = tz = 0;
            ...
            //************************ Cargar modelos 3ds ***********************************
            // formato 8 floats por vértice (x, y, z, A, B, C, u, v)
            casas = Load3DS("../../Modelos/casitodo.3ds", &num_verticescasas);
            casas2 = Load3DS("../../Modelos/casas2.3ds", &num_verticescasas2);

            break;
		}

		case COCHES_ID: {  // Creación de la carretera
		    tx = ty = tz = 0;
            ...
            //************************ Cargar modelos 3ds ***********************************
            // formato 8 floats por vértice (x, y, z, A, B, C, u, v)
            coche1 = Load3DS("../../Modelos/coche1.3ds", &num_verticescoche1);

            break;
		}

		case OTROCOCHE_ID: {  // Creación de la carretera
		    tx = ty = tz = 0;
            ...
            //************************ Cargar modelos 3ds ***********************************
            // formato 8 floats por vértice (x, y, z, A, B, C, u, v)
            coche2 = Load3DS("../../Modelos/coche2.3ds", &num_verticescoche2);

            break;
		}

		case RUEDAS_ID: {  // Creación de la carretera
		    tx = ty = tz = 0;
            ...
            //************************ Cargar modelos 3ds ***********************************
            // formato 8 floats por vértice (x, y, z, A, B, C, u, v)
            ruedas1 = Load3DS("../../Modelos/ruedas1.3ds", &num_verticesruedas1);
            ruedas2 = Load3DS("../../Modelos/ruedas2.3ds", &num_verticesruedas2);
		...
		case COCHE_ID: { // Creación del coche
            ...
            //************************ Cargar modelos 3ds ***********************************
            // formato 8 floats por vértice (x, y, z, A, B, C, u, v)
            //modelo0 = Load3DS("../../Modelos/cocherueda.3ds", &num_vertices0);
            //modelo1 = Load3DS("../../Modelos/ruedasola.3ds", &num_vertices1);
            break;
		}
	} // switch
}
...
void __fastcall TPrimitiva::Render(int seleccion, bool reflejo)
{
    ...
    switch (tipo) {
        ...
        case CASAS_ID: {
                ...
                glUniform4fv(escena.uColorLocation, 1, colores[1]);
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, casas);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, casas+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticescasas);

                // Pintar la carretera
                glUniform4fv(escena.uColorLocation, 1, colores[1]);
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, casas2);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, casas2+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticescasas2);
        ...
        case COCHES_ID: {
                ...
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, coche1);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, coche1+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticescoche1);
        ...
        case OTROCOCHE_ID: {
                ...
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, coche2);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, coche2+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticescoche2);
        ...
        case RUEDAS_ID: {
                ...
                glUniform4fv(escena.uColorLocation, 1, colores[1]);
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, ruedas1);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, ruedas1+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticesruedas1);

                // Pintar la carretera
                glUniform4fv(escena.uColorLocation, 1, colores[1]);
                //                   Asociamos los vértices y sus normales
                glVertexAttribPointer(escena.aPositionLocation, POSITION_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, ruedas2);
                glVertexAttribPointer(escena.aNormalLocation, NORMAL_COMPONENT_COUNT, GL_FLOAT, false, STRIDE, ruedas2+3);

                glDrawArrays(GL_TRIANGLES, 0, num_verticesruedas2);
