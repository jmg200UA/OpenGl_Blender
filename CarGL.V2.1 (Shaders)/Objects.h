...
public: // Atributos de la clase
		...
		float   *casas;        // modelo a representar
		int     num_verticescasas;   // número de vértices

		float   *casas2;        // modelo a representar
		int     num_verticescasas2;   // número de vértices

		float   *coche1;        // modelo a representar
		int     num_verticescoche1;   // número de vértices

		float   *coche2;        // modelo a representar
		int     num_verticescoche2;   // número de vértices

		float   *ruedas1;        // modelo a representar
		int     num_verticesruedas1;   // número de vértices

		float   *ruedas2;        // modelo a representar
		int     num_verticesruedas2;   // número de vértices
