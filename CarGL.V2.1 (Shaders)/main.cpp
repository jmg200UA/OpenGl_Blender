...
int main(int argc, char* argv[])
{
    ...
    TPrimitiva *casas= new TPrimitiva(3, CASAS_ID);
    TPrimitiva *coches= new TPrimitiva(4, COCHES_ID);
    TPrimitiva *ruedas= new TPrimitiva(5, RUEDAS_ID);
    TPrimitiva *otrocoche= new TPrimitiva(5, OTROCOCHE_ID);
    ...
    escena.AddObject(coches);
    escena.AddObject(ruedas);
    escena.AddObject(otrocoche);
